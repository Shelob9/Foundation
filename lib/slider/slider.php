...
// Enqueue Flexslider Files
	...
	function wptuts_slider_scripts() {
		...
		wp_enqueue_style( 'flex-style', get_template_directory_uri() . '/lib/slider/css/flexslider.css' );
	
		wp_enqueue_script( 'flex-script', get_template_directory_uri() .  '/lib/slider/js/jquery.flexslider-min.js', array( 'jquery' ), false, true );
	}
